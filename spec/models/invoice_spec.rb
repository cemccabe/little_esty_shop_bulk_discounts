...
RSpec.describe Invoice, type: :model do
  ...
  describe '#discounted_revenue' do
    ...
    it 'returns amount discounted' do
      expect(@invoice_1.total_discount).to eq(22.5)
    end

    it 'returns total revenue after discount' do
      expect(@invoice_1.revenue_after_discount).to eq(67.5)
    end
  end
end
